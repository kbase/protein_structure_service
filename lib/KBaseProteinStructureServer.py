...
from KBaseProteinStructureImpl import KBaseProteinStructure
impl_KBaseProteinStructure = KBaseProteinStructure(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'KBaseProteinStructure'
        ...
        self.rpc_service.add(impl_KBaseProteinStructure.lookup_pdb_by_fid,
                             ...
                             types=[list])
        self.rpc_service.add(impl_KBaseProteinStructure.lookup_pdb_by_seq,
                             name='KBaseProteinStructure.lookup_pdb_by_seq',
                             types=[list])
        ...
        if environ['REQUEST_METHOD'] == 'OPTIONS':
            ...
            try:
                ...
                try:
                    ...
                    impl_KBaseProteinStructure.ctx = ctx
