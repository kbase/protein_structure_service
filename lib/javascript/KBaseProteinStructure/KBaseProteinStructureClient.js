...
function KBaseProteinStructure(url, auth, auth_cb) {
    ...
    this.lookup_pdb_by_seq = function (protein_seqs, _callback, _errorCallback) {
    return json_call_ajax("KBaseProteinStructure.lookup_pdb_by_seq",
        [protein_seqs], 1, _callback, _errorCallback);
};

    this.lookup_pdb_by_seq_async = function (protein_seqs, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("KBaseProteinStructure.lookup_pdb_by_seq", [protein_seqs], 1, _callback, _error_callback);
    };
