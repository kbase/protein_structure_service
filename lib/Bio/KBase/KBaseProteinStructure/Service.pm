package Bio::KBase::KBaseProteinStructure::Service;
...
{
    my ($self) = @_;
    my $submod = $self->get_service_name() || 'KBaseProteinStructure';
    my $loggers = {};
...
sub call_method {
    ...
    my $ctx = Bio::KBase::KBaseProteinStructure::ServiceContext->new($self->{loggers}->{userlog},
    ...
    # Service KBaseProteinStructure does not require authentication.
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service KBaseProteinStructure.");
    }
...
package Bio::KBase::KBaseProteinStructure::ServiceContext;

use strict;

=head1 NAME

Bio::KBase::KBaseProteinStructure::ServiceContext
