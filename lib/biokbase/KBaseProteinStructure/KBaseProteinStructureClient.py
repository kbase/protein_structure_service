...
class KBaseProteinStructure(object):
    ...
    def lookup_pdb_by_md5(self, input_ids):
        ...
        arg_hash = {'method': 'KBaseProteinStructure.lookup_pdb_by_md5',
                    'params': [input_ids],
                    'version': '1.1',
    ...
    def lookup_pdb_by_fid(self, feature_ids):
        ...
        arg_hash = {'method': 'KBaseProteinStructure.lookup_pdb_by_fid',
                    'params': [feature_ids],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def lookup_pdb_by_seq(self, protein_seqs):
        ...
        arg_hash = {'method': 'KBaseProteinStructure.lookup_pdb_by_seq',
                    'params': [protein_seqs],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
