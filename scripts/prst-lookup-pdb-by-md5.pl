...
my $usage = "Usage: $0 [--url=http://kbase.us/services/protein_structure] [--domain_list=biological_process] [--evidence_code_list=IEA]  [--test_type=hypergeometric] [--p_value=XXX]< geneIDs  \n";
